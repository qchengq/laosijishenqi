...
var slide_verify = LSJAUTO_CONFIG.get("slide_verify", "300");
var fast_mode = ("fast_mode", false);
var ddtong = ("ddtong", false);
var is_exit = ("is_exit", false);
var pinglun = ("pinglun", false);
var shipin = ("shipin", false);
var wenzhang = ("wenzhang", false);
var meiri = ("meiri", true);
var meizhou = LSJAUTO_CONFIG.get("meizhou", 2);
var zhuanxiang = LSJAUTO_CONFIG.get("zhuanxiang", 2);
var tiaozhan = ("tiaozhan", true);
var sanren = ("sanren", false);
var ocr_choice = ("ocr_choice", 0);
var ocr_maxtime = LSJAUTO_CONFIG.get("ocr_maxtime", "1500");
var duizhan_mode = ("duizhan_mode", 0);
var jisu = ("jisu", "0");
var guaji = ("guaji", false);
var siren = ("siren", true);
var dacuo_num = ("dacuo_num", "0");
var shuangren = ("shuangren", true);
var bendi = ("bendi", false);
var dingyue = ("dingyue", 0);
...
function init_wh() {
  ...
  if (device.width == device_h && device.height == device_w) {
    ...
    fError("识别不出设备宽高，建议重启老司机神器后重新运行脚本");
    sleep(10000);
  }
