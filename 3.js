 ...
 * 如果完成就不需要浪费时间向下搜索
 *  */
var all_weekly_answers_completed = AUTOXUEXI_CONFIG.get("mzdt", "0");
 ...
 * 如果完成就不需要浪费时间向下搜索
 *  */
var all_special_answer_completed = AUTOXUEXI_CONFIG.get("zxdt", "0");

/**
 * 是否完成订阅模块
 * 请填入"yes"或"no"(默认为"yes")
 *  */
var whether_complete_subscription = AUTOXUEXI_CONFIG.get("dyue", "0");
 ...
 *  */
var AK = AUTOXUEXI_CONFIG.get("bdak", "");
var SK = AUTOXUEXI_CONFIG.get("bdsk", "");
